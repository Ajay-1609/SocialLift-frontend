  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="sociallift reviews, digital marketing testimonials, client reviews, marketing agency testimonials"
        />

        <meta name="author" content="SocialLift" />

        <meta property="og:title" content="Client Testimonials | SocialLift" />
        <meta
          property="og:description"
          content="See what our clients say about SocialLift digital marketing services."
        />
              ...
              {testimonials.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold transition-all duration-300 group-hover:bg-primary group-hover:text-black">
                      {item.initials}
                    </div>

                    <div>
                      <h4 className="font-semibold text-dark flex items-center gap-2 group-hover:text-primary transition-colors duration-300">
                        {item.name}
